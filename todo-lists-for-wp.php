...
final class TodoListsForWP
{
    ...
    {
        _doing_it_wrong(__FUNCTION__, __('Cloning is forbidden.', 'todo-lists-for-wp'), '1.0.0');
    }
    ...
    {
        _doing_it_wrong(__FUNCTION__, __('Unserializing instances of this class is forbidden.', 'todo-lists-for-wp'), '2.1');
    }
    ...
    {
        load_plugin_textdomain('todo-lists-for-wp', false, dirname(plugin_basename(__FILE__)) . '/languages/');
    }
...
function todo_list_for_wp()
{
    return TodoListsForWP::instance();
}
