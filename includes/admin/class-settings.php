...
class Settings
{
	...
	function get_settings_sections()
	{
		$sections = array(
			array(
				'id'    => 'tdlw_settings',
				'title' => __('Todo List Settings', 'todo-lists-for-wp')
			),
		);
		...
		$settings_fields = array(
			...
			'tdlw_settings' => array(
				...
				array(
					...
					'label'   => __('Add Todo Option', 'todo-lists-for-wp'),
					'type'    => 'checkbox',
					'default' => false,
					'checked' => true,
	...
	{
		add_menu_page(
			__('Todo Settings', 'todo-lists-for-wp'),
			'Todo List Settings',
			'manage_options',
			'tdlw_settings',
	...
	function settings_page()
	{
		...
		if ($options != '') {
			echo '<p>' . __("Place the shortcode and you will get the form.", "todo-lists-for-wp") . '</p>';
			echo '<h1 style="margin-top: 0px;">' . __("[todo_lists]", "todo-lists-for-wp") . '</h1>';
		}
