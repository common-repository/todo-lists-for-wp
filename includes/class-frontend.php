...
class Frontend
{
	...
	public function enqueue_scripts($hook)
	{
		...
		wp_register_style('todo-lists-for-wp', TDLW_ASSETS_URL . "/css/frontend.css", TDLW_VERSION);
		wp_register_script('todo-lists-for-wp', TDLW_ASSETS_URL . "/js/frontend/frontend.js", ['jquery', 'wp-util'], TDLW_VERSION, true);
		...
		wp_localize_script(
			...
			[
				...
				'nonce'         			=> wp_create_nonce('todo-lists-for-wp')
			]
		);
	}
}
